...
export const AudioFlashcards: React.FC<FlashcardsProps> = ({ soundEnabled, onGotIt }) => {
            ...
            <div className="my-auto py-6 text-center space-y-3">
              {!isFlipped ? (
                ...
                <div className="animate-fadeIn space-y-3">
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-red-600 dark:text-red-400 tracking-tight leading-tight">
                    {currentCard.turkish}
                  </h2>
                  <div className="bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900/50 rounded-2xl px-3 py-2.5 mx-auto max-w-sm">
                    <p className="text-[10px] font-black uppercase tracking-wider text-amber-600 dark:text-amber-400 flex items-center justify-center gap-1 mb-1">
                      <ScrollText className="w-3 h-3" /> Read it out loud:
                    </p>
                    <p className="text-xs sm:text-sm text-amber-900 dark:text-amber-200 font-mono font-bold leading-relaxed">
